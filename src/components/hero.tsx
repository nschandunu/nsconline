    ...
    const timer = setTimeout(() => {
      let ctx = gsap.context(() => {
        ...
        tl.fromTo(imacRef.current, { scale: 2.5 }, { scale: 1 })
          ...
          .fromTo(glowRef.current, { opacity: 0 }, { opacity: 1, yoyo: true, repeat: 1 }, '<')
    ...
    <div ref={componentRef} className="relative h-[200vh]">
      <div className="sticky top-0 flex h-screen w-full items-center justify-center overflow-hidden">
        <div ref={imacRef} className="relative">
          ...
          />
          <div ref={contentRef} className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center">
            <div className="relative mb-4">
              <div ref={glowRef} className="absolute -inset-1 rounded-full bg-gradient-to-br from-pink-400 via-blue-400 to-purple-500 blur-xl"></div>
            ...
            <div className="flex items-center gap-1">
              <p className="text-lg font-medium text-gray-700">Senuka Chandunu</p>
            ...
            <h1 className="mt-1 text-5xl font-extrabold tracking-tighter text-gray-900">Jrteghert reh erge.</h1>
            <a href="#" className="mt-6 flex items-center text-lg font-medium text-blue-600 hover:underline">
              Start a project request
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="ml-1 h-5 w-5">
